...
def get_countries():
    ...
    if response.status_code == 200:
        ...
        return None
print(get_countries()[1])
# for country in get_countries():
#     print(country["name"])

# for country in get_countries():
#     if country["alpha3Code"] == "AFG":
#         print(country["currencies"])

def get_country_code(get_countries, country_name):
    ...
    return None
#print(get_country_code(get_countries, "Albania"))

def get_country_currency(get_countries, country_name: str):
    countries = get_countries()
    for country in countries:
        if country['name'] == country_name:
...
def get_country_currency_2(countries : list, country_name: str):
